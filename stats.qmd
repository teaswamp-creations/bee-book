...
upset_list = list(`Has PM map` = unique(paste(gbif_v3$family, gbif_v3$Genus, gbif_v3$Species)),
                  `In bee gallery` = unique(paste(df_v3$Family, df_v3$Genus, df_v3$Species)), 
                  `Has image` = unique(paste(df_v3$Family, df_v3$Genus, df_v3$Species)[!is.na(df_v3$`Image link`)])
)
