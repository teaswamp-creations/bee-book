...
* Click any image to be taken to the database source showing where and when bees have been seen in the region
...
1.	Research grade on iNaturalist, and seen in Pacific Maritime
2.	Specimen available in the UBC SEC, and seen in the Pacific Maritime
3.	Research grade on iNaturalist, with sighting outside of the Pacific Maritime
4.	Galiano Life List
5.	Specimen available in the SEC, with sighting outside of the Pacific Maritime 
6.	Species listed by Sheffield and Heron but not otherwise documented in GBIF, iNaturalist, the Spencer Entomological Collection
...
See the [Ecozones Framework of Canada](http://www.ecozones.ca) for more informaiton. 
...
gbif %>%
  ...
  labs(x = 'Family', y = 'Number of Species', fill = "Aggregator") +
  scale_fill_manual(values = c('grey70', '#376D61'), labels = c("GBIF", "Bee Book Gallery"))
